...
x_train_dir = Infra_Config.IMG_DIR + '/x_train'
y_train_dir = Infra_Config.IMG_DIR + '/y_train'

x_val_dir = Infra_Config.IMG_DIR + '/x_val'
y_val_dir = Infra_Config.IMG_DIR + '/y_val'
...
for i in range(0, Infra_Config.EPOCHS):
    ...
    print(train_logs['fscore'],val_logs['fscore'])
    ...
    if i == 30:
        Infra_Config.OPTIMIZER.param_groups[0]['lr'] = 1e-4
