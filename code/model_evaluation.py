...
x_test_dir = Infra_Config.IMG_DIR + '/x_test'
y_test_dir = Infra_Config.IMG_DIR + '/y_test'
...
labels = np.empty([291, Infra_Config.CLASSES, Infra_Config.SIZE, Infra_Config.SIZE])
preds = np.empty([291, Infra_Config.CLASSES, Infra_Config.SIZE, Infra_Config.SIZE])
for i, id_ in tqdm(enumerate(test_dataset), total = len(test_dataset)):
